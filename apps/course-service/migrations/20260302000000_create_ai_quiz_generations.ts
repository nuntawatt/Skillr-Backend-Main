...
export class CreateAiQuizGenerations20260302000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.createTable(
        new Table({
          ...
          columns: [
            ...
            { name: 'model_name', type: 'varchar', length: '100', isNullable: false },
    ...
    const fkName = 'FK_ai_quiz_generations_lesson_id';
