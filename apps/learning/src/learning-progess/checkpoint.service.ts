...
export class CheckpointService {
  ...
  async checkCheckpointUnlock(
    ...
    const completedCount = await this.lessonProgressService.getCompletedLessonsCount(
      userId, 
      precedingLessonIds
    );
  ...
  async unlockCheckpoint(userId: number, checkpointLessonId: number): Promise<void> {
