...
export class CreateChapterDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'This chapter covers the basics of TypeScript.',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'ID of the level this chapter belongs to',
    example: 1,
  })
  @IsInt()
  level_id: number;
  ...
  @ApiPropertyOptional({
    description: 'Order index of the chapter within the level',
    example: 1,
  })
  @IsInt()
  @IsOptional()
